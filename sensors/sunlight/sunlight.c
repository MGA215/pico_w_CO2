 ...
 */
static inline int32_t sl_get_error(uint16_t error_reg);
...
int32_t sunlight_read(uint8_t addr, uint8_t* buf, uint16_t num_bytes)
{
    int32_t ret;
...
int32_t sunlight_write(uint8_t addr, uint8_t* buf, uint16_t len)
{
    int32_t ret;
